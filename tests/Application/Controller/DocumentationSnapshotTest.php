...
class DocumentationSnapshotTest extends WebTestCase
{
    ...
    public function testDocumentationCriticalPathsSnapshot(): void
    {
        ...
        $snapshot = [
            ...
            '/v1/recruit/private/applications/{applicationId}/interviews' => ['get', 'post'],
            '/v1/recruit/private/interviews/{interviewId}' => ['patch', 'delete'],
            '/v1/recruit/applications/{applicationSlug}/private/applications/{applicationId}/status' => ['patch'],
            '/v1/recruit/applications/{applicationSlug}/private/applications/{applicationId}/status-history' => ['get'],
