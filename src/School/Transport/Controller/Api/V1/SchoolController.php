...
final readonly class SchoolController
{
    ...
    {
        $items = array_map(static fn (SchoolClass $schoolClass): array => [
    ...
    #[OA\Post(summary: 'POST /v1/school/classes', requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['payload'], properties: [
        ...
        ])), tags: ['School'], parameters: [], responses: [new OA\Response(response: 201, description: 'Success.'), new OA\Response(response: 400, description: 'Bad request.'), new OA\Response(response: 401, description: 'Unauthorized.'), new OA\Response(response: 404, description: 'Not found.'), new OA\Response(response: 422, description: 'Validation error.')])]
    ...
    {
        $items = array_map(static fn (Student $student): array => [
            'id' => $student->getId(),
            'name' => $student->getName(),
            'classId' => $student->getSchoolClass()?->getId(),
        ], $this->studentRepository->findBy([], [
            'createdAt' => 'DESC',
        ], 200));
    ...
    #[OA\Post(summary: 'POST /v1/school/students', requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['payload'], properties: [
        new OA\Property(property: 'payload', type: 'object', example: [
            'value' => 'example',
        ])], example: [
            'payload' => [
    ...
    {
        $items = array_map(static fn (Teacher $teacher): array => [
            'id' => $teacher->getId(),
            'name' => $teacher->getName(),
        ], $this->teacherRepository->findBy([], [
            'createdAt' => 'DESC',
        ], 200));
    ...
    #[OA\Post(summary: 'POST /v1/school/teachers', requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['payload'], properties: [
        new OA\Property(property: 'payload', type: 'object', example: [
            'value' => 'example',
        ])], example: [
            'payload' => [
    ...
    #[OA\Post(summary: 'POST /v1/school/exams', requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['payload'], properties: [
        new OA\Property(property: 'payload', type: 'object', example: [
            'value' => 'example',
        ])], example: [
            'payload' => [
    ...
    {
        $items = array_map(static fn (Grade $grade): array => [
            'id' => $grade->getId(),
            'score' => $grade->getScore(),
            'studentId' => $grade->getStudent()?->getId(),
            'examId' => $grade->getExam()?->getId(),
        ], $this->gradeRepository->findBy([], [
            'createdAt' => 'DESC',
        ], 200));
    ...
    #[OA\Post(summary: 'POST /v1/school/grades', requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['payload'], properties: [
        new OA\Property(property: 'payload', type: 'object', example: [
            'value' => 'example',
        ])], example: [
            'payload' => [
