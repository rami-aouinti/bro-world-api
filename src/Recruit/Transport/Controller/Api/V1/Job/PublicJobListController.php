...
readonly class PublicJobListController
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'yearsExperienceMin', in: 'query', required: false, schema: new OA\Schema(type: 'integer', minimum: 0)),
            new OA\Parameter(name: 'yearsExperienceMax', in: 'query', required: false, schema: new OA\Schema(type: 'integer', minimum: 0)),
