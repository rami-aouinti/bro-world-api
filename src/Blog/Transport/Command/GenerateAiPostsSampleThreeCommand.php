...
final class GenerateAiPostsSampleThreeCommand extends Command
{
    public const string NAME = 'app:generate-ai-posts-sample-three';
    ...
    private const array TOPICS = [
        ...
        'The future of education and e-learning',
