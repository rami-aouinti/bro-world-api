...
class CancelApplicationEventController
{
    ...
    #[Route(path: '/v1/calendar/applications/{applicationSlug}/private/events/{eventId}/cancel', methods: [Request::METHOD_POST])]
