...
class CreateApplicationEventController
{
    ...
    #[Route(path: '/v1/calendar/applications/{applicationSlug}/private/events', methods: [Request::METHOD_POST])]
