...
class PatchApplicationEventController
{
    ...
    #[Route(path: '/v1/calendar/applications/{applicationSlug}/private/events/{eventId}', methods: [Request::METHOD_PATCH])]
