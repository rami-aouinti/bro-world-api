...
readonly class PatchApplicationEventController
{
     ...
     * @throws Throwable
     */
    #[Route(path: '/v1/calendar/applications/{applicationSlug}/events/{eventId}', methods: [Request::METHOD_PATCH])]
